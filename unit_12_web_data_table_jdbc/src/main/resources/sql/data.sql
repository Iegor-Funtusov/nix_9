insert into authors values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Christian', 'Bauer');
insert into authors values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Gavin', 'King');
insert into authors values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Gary', 'Gregory');
insert into authors values (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Bruce', 'Eckel');
insert into authors values (5, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Brian', 'Goetz');
insert into authors values (6, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Tim', 'Peierls');
insert into authors values (7, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Joshua', 'Bloch');
insert into authors values (8, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Joseph', 'Bowbeer');
insert into authors values (9, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'David', 'Holmes');
insert into authors values (10, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Doug', 'Lea');
insert into authors values (11, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Raoul-Gabriel', 'Urma');
insert into authors values (12, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true, 'Mario', 'Fusco');
...
Thinking in Java has earned raves from programmers worldwide for its extraordinary clarity, careful organization, and small, direct programming examples. From the fundamentals of Java syntax to its most advanced features, Thinking in Java is designed to teach, one simple step at a time.
    ...
    Live seminars, consulting, and reviews available. See www.MindView.net', 'https://balka-book.com/files/2021/05_03/21_34/u_files_store_1_490060.jpg', 1150, 2006);
...
Advanced topics such as atomic variables, nonblocking algorithms, and the Java Memory Model', 'https://balka-book.com/files/2021/05_03/21_28/u_files_store_1_472075.jpg', 384, 2006);
...
Mario Fusco is an engineer at Red Hat and creator of the lambdaj library. Alan Mycroft is a professor at Cambridge and cofounder of the Raspberry Pi Foundation.', 'https://balka-book.com/files/2021/05_03/21_28/u_files_store_1_472037.jpg', 394, 2015);
...
You’ll gain in-depth knowledge of Java application performance, using the Java Virtual Machine (JVM) and the Java platform, including the language and API. Developers and performance engineers alike will learn a variety of features, tools, and processes for improving the way Java 7 and 8 applications perform.
    ...
    Improve Java-driven database application performance', 'https://balka-book.com/files/2021/05_03/21_42/u_files_store_1_517038.jpg', 426, 2014);
...
insert into author_book values (5, 3);
insert into author_book values (6, 3);
insert into author_book values (7, 3);
insert into author_book values (8, 3);
insert into author_book values (9, 3);
insert into author_book values (10, 3);
insert into author_book values (7, 4);
insert into author_book values (11, 5);
insert into author_book values (12, 5);
insert into author_book values (13, 5);
insert into author_book values (14, 6);
insert into author_book values (14, 7);

insert into publisher_book values (1, 1);
insert into publisher_book values (2, 2);
insert into publisher_book values (3, 3);
insert into publisher_book values (3, 4);
insert into publisher_book values (1, 5);
insert into publisher_book values (4, 6);
insert into publisher_book values (4, 7);
